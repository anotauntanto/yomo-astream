...
dataLogsPathsAll = rdir('./**/2017-10-05_base_eval/**/YT_*buffer.txt');
eventLogsPathsAll = rdir('./**/2017-10-05_base_eval/**/YT_*events.txt');
tsharkLogsPathsAll = rdir('./**/2017-10-05_base_eval/**/YT_tshark__*.txt');

dataLogsPathsID1 = rdir(strcat('./**/2017-10-05_base_eval/**/YT_', ytIds{1} ,'_*buffer.txt'));
eventLogsPathsID1 = rdir(strcat('./**/2017-10-05_base_eval/**/YT_', ytIds{1} ,'_*events.txt'));
dataLogsPathsID2 = rdir(strcat('./**/2017-10-05_base_eval/**/YT_', ytIds{2} ,'_*buffer.txt'));
eventLogsPathsID2 = rdir(strcat('./**/2017-10-05_base_eval/**/YT_', ytIds{2} ,'_*events.txt'));
dataLogsPathsID3 = rdir(strcat('./**/2017-10-05_base_eval/**/YT_', ytIds{3} ,'_*buffer.txt'));
eventLogsPathsID3 = rdir(strcat('./**/2017-10-05_base_eval/**/YT_', ytIds{3} ,'_*events.txt'));
dataLogsPathsID4 = rdir(strcat('./**/2017-10-05_base_eval/**/YT_', ytIds{4} ,'_*buffer.txt'));
eventLogsPathsID4 = rdir(strcat('./**/2017-10-05_base_eval/**/YT_', ytIds{4} ,'_*events.txt'));
...
figure(5);
hold all;
plot(bandwidth{2, 1}/8000);
ylabel('tcp length [kbps]');
...
figure(1);
hold all;
arrayfun(@(x) plot(x{1}(:,1)-x{1}(1,1)+x{1}(1,3),x{1}(:,3)), bufferID1,'un',0);
ylabel('buffered playback time [s]');
xlabel('time since start of the video [s]');

figure(2);
hold all;
arrayfun(@(x) plot(x{1}(:,1)-x{1}(1,1)+x{1}(1,3),x{1}(:,3)), bufferID2,'un',0);
ylabel('buffered playback time [s]');
xlabel('time since start of the video [s]');

figure(3);
hold all;
arrayfun(@(x) plot(x{1}(:,1)-x{1}(1,1)+x{1}(1,3),x{1}(:,3)), bufferID3,'un',0);
ylabel('buffered playback time [s]');
xlabel('time since start of the video [s]');

figure(4);
hold all;
arrayfun(@(x) plot(x{1}(:,1)-x{1}(1,1)+x{1}(1,3),x{1}(:,3)), bufferID4,'un',0);
ylabel('buffered playback time [s]');
xlabel('time since start of the video [s]');
